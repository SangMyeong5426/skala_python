...
-- (student 1001, 1010은 enroll에만 있는 고아 데이터라 여기서 학생정보 NULL로 나옴)
-- ============================================================
...
-- (안티패턴 회피: JOIN 후 DISTINCT 대신 EXISTS로 애초에 중복 없이)
-- ============================================================
SELECT s.student_id, s.name
FROM lab.student s
WHERE EXISTS (
...
-- ============================================================
-- 문항 9 — 모든 직원과 그 매니저 이름 (Self join, CEO는 매니저 없음)
-- ============================================================
...
-- ============================================================
-- 문항 10 — "모든 학생 기준"으로 과목 분포 (LEFT JOIN + 집계)
-- ============================================================
...
-- (이 스키마는 major가 student 테이블에 이미 내장돼 있어, 별도 학과 테이블 대신
--  스칼라 서브쿼리 형태로 같은 값을 뽑아오는 방식으로 문법을 연습합니다)
-- ============================================================
SELECT s.student_id, s.name,
...
-- ============================================================
-- 문항 19 — HR 학과 학생 일부와의 비교 데모 (전체 평균 GPA 대비)
-- ============================================================
...
-- ============================================================
-- 문항 23 — 학과별 GPA Top3 (서브쿼리 방식 + CTE 방식, 동점 처리 비교)
-- ============================================================
